...
public class Movie_VO {
   private String movie_idx,title,rate,story,genre,director,cast,running_time,poster,start_time,review_cnt,age_img;
   
   public Movie_VO() {}

   public Movie_VO(String movie_idx, String title, String rate, String story, String genre, String director,
         String cast, String running_time, String poster, String start_time, String review_cnt, String age_img) {
      super();
   ...
   public void setAge_img(String age_img) {
      this.age_img = age_img;
   }
